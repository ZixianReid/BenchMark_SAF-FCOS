...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="/ZXH_Zixian_Zhang/code/SAF-FCOS/configs/WaterScene/fcos_imprv_R_50_FPN_FUSION.yaml",
        metavar="FILE",
    ...
    parser.add_argument(
        "--norm_info",
        default="/ZXH_Zixian_Zhang/dataset/WaterScene/norm_param_gt_coco_train.json",
        metavar="FILE",
        help="path to config file",
        type=str,
    )
