...
from flowScene.flowScene import FlowScene
from flowScene.visual import Visualization2D
import numpy as np
from flowScene import transformation
import os
import cv2
...
if __name__ == '__main__':
    ...
    flowsc = FlowScene(root_dir=args.dataroot)
    run()
