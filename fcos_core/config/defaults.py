...
_C.INPUT.PIXEL_MEAN = [182.07061149691359, 186.43203221450617, 181.51915943287037]
# Values to be used for image normalization
_C.INPUT.PIXEL_STD = [1., 1., 1.]

_C.INPUT.PC_MEAN = [1.6315, 1.4805, 1.3278]
_C.INPUT.PC_STD = [1., 1., 1.]
_C.INPUT.PC_NUM_CHANNEL = 3
...
# Fusion scheme for backbone
_C.MODEL.BACKBONE.FUSION = 'IMG'
_C.MODEL.BACKBONE.FUSION_MIX_KERNEL_SIZES = (1, 3, 5)
_C.MODEL.BACKBONE.FUSION_MIX_PADDINGS = (0, 1, 2)
...
_C.OUTPUT_DIR = "/ZXH_Zixian_Zhang/code/SAF-FCOS/tmp1"
