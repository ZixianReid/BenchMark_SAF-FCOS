...
def build_transforms(cfg, is_train=True):
    ...
    if cfg.MODEL.BACKBONE.FUSION == 'IMG':
        ...
        normalize_transform = T.NormalizePC(mean=cfg.INPUT.PIXEL_MEAN, std=cfg.INPUT.PIXEL_STD, pc_mean=cfg.INPUT.PC_MEAN,
                                          pc_std=cfg.INPUT.PC_STD, to_bgr255=to_bgr255)
